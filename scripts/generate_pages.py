...
<div class="card">
  ...
  <div class="quiz-grid">
    <p class="hint">※ 예시 숫자는 정답 힌트가 아니라, 일부러 오래된 상식에 가까운 “가상 예상값”입니다. 학생들은 자기 생각으로 바꿔 적어 보세요.</p>
    <label>한국 기대수명은 몇 년일까?<input id="guess-life-kor" type="number" placeholder="예: 75"></label>
    <label>세계 5세 미만 사망률은 1,000명당 몇 명일까?<input id="guess-mort-world" type="number" placeholder="예: 80"></label>
    <label>인도 전기 접근성은 몇 %일까?<input id="guess-electricity-ind" type="number" placeholder="예: 65"></label>
    <label>나이지리아 1인당 GDP는 몇 달러일까?<input id="guess-gdp-nga" type="number" placeholder="예: 5000"></label>
  </div>
